...
If the user's request is unclear or not aligned with the page, still provide the best single next action and the closest alternative without asking questions.
...
If the user's request is unclear or not aligned with anything on the page, still provide the closest practical next step without asking questions.
...
async function handleGeminiResponse(response, type, pageData) {
    ...
    if (clarifyMatch) {
        response = 'Click the most relevant option on the page to continue.';
    }
